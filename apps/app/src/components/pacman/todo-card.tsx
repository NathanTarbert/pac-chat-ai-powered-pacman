...
export function PacManTodoCard({
  ...
  return (
    <div
      className={`group relative rounded-lg p-5 transition-all duration-150 border-2 animate-[score-pop_0.3s_ease-out] ${
        isCompleted
      ...
      <div className="flex items-start gap-3">
        ...
        >
          {isCompleted ? (
            ...
            <div
              className="w-6 h-6 rounded-full border-2 border-[#ffb8ae] bg-transparent"
